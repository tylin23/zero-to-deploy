  ...
  return (
    <div className="max-w-[720px] mx-auto">
      ...
      <div className="card space-y-4">
        ...
        >
          <b className="text-ink">每一種部署方式都有它的風險。</b>「部署」的本質，就是把你的檔案或資料，放到
          <b className="text-ink">你自己電腦以外的地方</b>
          （別人的平台、對外的網路）。在動手之前，請務必想清楚：
          <b className="text-ink">這份資料，真的可以上傳／對外嗎？</b>
        </div>
        ...
        <section>
          ...
          <ul className="grid gap-2 list-disc pl-6 text-sm text-ink mt-2">
            <li>
              <b>上傳前先確認可以上傳。</b>
              確認這份資料屬於可公開或可交付第三方的範圍，並符合機關的資訊公開與資安規範、必要時先取得長官核准。
            </li>
            <li>
              <b>保護個人資料。</b>
              切勿把市民個資（姓名、身分證號、電話、陳情內容）或公務機密上傳到對外／第三方平台，以免違反《個人資料保護法》與相關規定。
            </li>
            <li>
              <b>練習用假資料。</b>本教材與各平台練習，一律使用<b>假資料或去識別化資料</b>
              ，不要用真實的公務或市民資料。
            </li>
            <li>
              <b>境外第三方服務。</b>GitHub、Hugging Face、Discord/Slack
              等多為境外服務；上傳等於把資料交給第三方，可能被保存、索引或用於改善其服務。
            </li>
            <li>
              <b>金鑰與密碼。</b>Webhook 網址、API 金鑰、憑證等同通行鑰匙，切勿寫進公開的原始碼或截圖分享。
            </li>
          </ul>
        </section>
        ...
        <label className="flex items-start gap-3 p-3.5 border-2 border-line rounded-[14px] bg-surface cursor-pointer">
          ...
          <span className="text-sm text-ink font-bold">
            我已閱讀並了解上述風險，會留意自身資料與資安，並確保上傳的資料是可以公開／可上傳的。
          </span>
        </label>
