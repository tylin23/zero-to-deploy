...
export const TERMS = [
  {
    ...
    relation:
      "一頁很多人看的開放資料看板，用快取讓大家秒回、資料源也不會被一直打爆。但要注意：資料更新了，快取可能還是舊的——所以要處理「什麼時候該更新快取」。",
  },
  {
    id: "queue",
    emoji: "🎢",
    ...
    relation:
      "要一次寄大量通知、產大量報表時，把任務丟進佇列排隊，使用者馬上得到回應、系統不被瞬間塞爆、失敗還能重試。",
  },
  {
    id: "cdn",
    emoji: "🌐",
  ...
  },
  {
    ...
    relation:
      "民眾表單網路卡、連按兩次「送出」，系統不應該就建立兩筆一模一樣的案件。用「申請編號」判斷是不是同一筆，就能避免重複。",
  },
  {
    id: "logmon",
    emoji: "📈",
    ...
    relation:
      "服務掛了、出錯了要能馬上知道，事後也能回頭查原因。交接給資訊單位時，他們一定會問「怎麼監控、出事怎麼通知」。",
  },
  {
    id: "env",
    emoji: "🚦",
    ...
    relation:
      "要改線上的公告或系統，先在測試環境試好再上正式，避免民眾看到壞掉的畫面。這是最重要、也最常被忽略的維運觀念。",
  },
  {
    id: "backup",
    emoji: "💾",
    ...
    relation:
      "名冊、系統資料要定期備份，而且要「真的試過還原得回來」。「刪掉了能不能救」是納管一定會被問的。",
  },
  {
    id: "rollback",
    emoji: "↩️",
