    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto_1fr] items-center gap-2.5">
        ...
        <div className="relative h-[60px] max-sm:rotate-90">
          ...
          />
          <div
            className="absolute top-1/2 -translate-y-1/2 text-2xl transition-[left,opacity] duration-[900ms]"
            style={{ left, opacity }}
          >
            {emoji}
          </div>
      ...
      <button type="button" className="btn btn-accent" onClick={play}>
        ▶ 播放
      </button>
...
function Node({ emoji, label, sub }) {
  return (
    <div
      className="text-center py-4 px-3 rounded-[22px] border-2 border-line bg-surface"
