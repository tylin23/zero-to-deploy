...
const CASES = [
  ...
  },
  {
    ...
    answer: "no",
    why: "repo 設成 Public，裡面「每一個檔案」都會公開，不是只有網頁那一頁 —— 名冊一傳上去，民眾個資就攤在網路上了。而且 GitHub 會留版本紀錄，事後刪掉也可能已經被搜尋引擎索引、被第三方存檔。備份請用機關既有的空間，別拿公開的 repo 當雲端硬碟。（想線上收報名資料的正確做法，第 5 關會教）",
  },
  {
    text: "把研考會已經公開的「陳情案件分類統計」，做成一張看板給科室同仁參考。",
    answer: "self",
    why: "這份開放資料只有案件類別、受理機關和日期，沒有陳情人的姓名電話，也不是給市民用的正式服務 —— 屬於可以自己做的範圍。（第 4 關就會教你怎麼讓這張看板自動去抓最新資料）",
  },
  {
