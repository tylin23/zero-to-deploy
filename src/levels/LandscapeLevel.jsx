...
const AI_TOOLS = [
  {
    ...
    watch:
      "發布後是「拿到連結的人都能開」。它不會被放進任何公開目錄讓人瀏覽，但只要連結被轉傳一次就收不回來。團隊／企業方案可以改成只給組織內部、而且要登入才看得到。",
  },
  {
    id: "gemini",
    emoji: "🎨",
  ...
  },
  {
    ...
    watch:
      "2026 年 7 月才推出、目前仍是公開測試，而且歐洲經濟區、瑞士、英國尚未開放。這提醒了一件事：能不能用、用多久、怎麼收費，是平台說了算，不是你說了算。",
  },
];
...
const LANDSCAPE = [
  ...
  },
  {
    key: "exe-queue",
    care: 4,
    one: "不一定要上網：包成一個檔案發給特定同仁，或讓大量任務排隊在背景慢慢跑。",
  },
  {
    key: "selfhost",
    care: 5,
